const coverDarkTheme =`<!DOCTYPE html>
<html>
...
<body>
    <section class="hero is-fullheight is-default is-bold has-background-black-ter has-text-white">
        <div class="hero-body">
        ...
        <footer class="footer has-background-black has-text-white" style="padding-bottom: 3rem;padding-top: 3rem;">
